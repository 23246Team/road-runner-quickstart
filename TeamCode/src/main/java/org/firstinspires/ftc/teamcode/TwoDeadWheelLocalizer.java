...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1295.2000156314366; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -618.2397372113824; // x position of the perpendicular encoder (in tick units)
    }
